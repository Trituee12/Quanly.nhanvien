...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<c:url value="/WEB-INF/assets/css/bootstrap.css"/>" rel="stylesheet">
    <!--external css-->
    <link href="<c:url value="/WEB-INF/assets/font-awesome/css/font-awesome.css"/>" rel="stylesheet" />
        
    <!-- Custom styles for this template -->
    <link href="<c:url value="/WEB-INF/assets/css/style.css"/>" rel="stylesheet">
    <link href="<c:url value="/WEB-INF/assets/css/style-responsive.css"/>" rel="stylesheet">
  ...
  <body>
    ...
    <script>
        $.backstretch("<c:url value="/hinhanh/VKTPd2M.jpg"/>", {speed: 500});
    </script>
